      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://summitmathlab.com"
              className="flex items-center gap-2 text-white/80 hover:text-white transition-colors text-sm font-medium border-r border-white/20 pr-4 mr-1"
            >
              ← Back to Main Site
            </a>
          ...
          <div className="flex space-x-2">
            ...
            <Link
              to="/angles"
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center gap-2 ${isActive('/angles')
                ? 'bg-slate-600 text-white shadow-lg'
                : 'text-white hover:bg-blue-700'
                }`}
            >
            ...
            <Link
              to="/diagonals"
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center gap-2 ${isActive('/diagonals')
                ? 'bg-slate-600 text-white shadow-lg'
                : 'text-white hover:bg-blue-700'
                }`}
            >
            ...
            <Link
              to="/help"
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center gap-2 ${isActive('/help')
                ? 'bg-slate-600 text-white shadow-lg'
                : 'text-white hover:bg-blue-700'
                }`}
            >
